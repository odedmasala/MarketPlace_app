const musicProduct = [
    ...
    },
    {
      ...
      manufacture: "בטהובן ובניו",
      brand: "Antigua",
      description: "טרומבון ברס סלייד מסדרת X/P, כולל פיה, מטלית ניקוי וארגז נשיאה מבית Antigua",
      quantity: 35,
      createBy: "shely admin"
    },
    {
      ...
      brand: "Valencia ",
      description: "Valencia נוסדה באוסטרליה לפני כ50 שנה וכיום מייצרת גיטרות מדהימות שמאופיינות באיכות גבוהה במיוחד ביחס למחיר.",
      quantity: 25,
      createBy: "shely admin"
    },
    {
    ...
    },
    {
      ...
      manufacture: "בטהובן ובניו",
      brand: "Gibson Les",
      description: "ה-Les Paul בגרסה קלאסית חדשה, רלוונטית ואהובה גם היום עבור כל כך הרבה נגנים במגוון סגנונות.",
      quantity: 42,
      createBy: "shely admin"
    },
    {
      ...
      manufacture: "כלי זמר",
      brand: "Ibanez",
      description: "סדרת הבס Talman משלבת עיצוב יפהפה של צורת הגוף ההיסטורית של Ibanez עם הסאונד הורסטילי המפתיע וחוצה הז'אנרים.",
      quantity: 15,
      createBy: "shely admin"
    },
    {
      ...
      manufacture: "כלי זמר",
      brand: "Legrand",
      description: "גיטרה אקוסטית עם צליל עשיר ורמת גימור גבוהה מבית מבית Legrand",
      quantity: 25,
      createBy: "shely admin"
    },
    {
      ...
      manufacture: "כלי זמר",
      brand: "Yamaha",
      description: "סדרת Recording Custom מבית Yamaha היא פסגת האומנות עם איכות בניה וצליל ברמה הגבוהה ביותר.",
      quantity: 42,
      createBy: "shely admin"
    },
    {
      ...
      manufacture: "כלי זמר",
      brand: "Meinl",
      description: "תופי יד מצוידים בראש העיזים הטובים ביותר שנבחרו ביד. המסגרת המסולסלת מבטיחה אחיזה נוחה, המאפשרת לאצבעות להפעיל לחץ לצורך תו 'כיפוף'. הבנייה הקלה והעם זאת מוצקה שלהם הופכת אותם למושלמים לסיטואציות ניידות וכלי הקשה ברחוב.",
      quantity: 12,
      createBy: "shely admin"
    },
    {
    ...
    },
    {
      ...
      manufacture: "כלי זמר",
      brand: "STAGG",
      description: "תוף מצעד גדול מסוג בייס-דראם, התוף בנוי מ-7 רבדים של עץ טיליה (Basswood) איכותי בעל הדהוד גדול ומלא בנוכחות. הוא מוחזק משני צידיו על ידי חישוקי מתכת בקוטר 1.5 מילימטר והוא מצויד בשמונה זוגות של זיזים חזקים מפלדה מותכת. מבית Stagg.",
      quantity: 44,
      createBy: "shely admin"
    },
    {
      ...
      brand: "Yamaha",
      description: "PSR EW410 היא מקלדת האם של סדרת PSR-E המיועדת לנגנים המכוונים יותר לנגינת פסנתר והופעה על במה.",
      quantity: 25,
      createBy: "shely admin"
    },
    {
      ...
      manufacture: "כלי ואן-גוך",
      brand: "Spirio",
      description: "החדשנות של Steinway עולה שלב נוסף עם הסדרה היוקרתית Spirio ופותחת עבורכם הפסנתרנים ואוהבי המוזיקה עולם שלם של אפשרויות: לנגן, להקליט, להפוך את ההופעה שלכם לבלתי נשכחת וליהנות ממוזיקה בצורה פורצת דרך בהחלט !",
      quantity: 40,
      createBy: "shely admin"
    },
    {
      ...
      manufacture: "כלי ואן-גוך",
      brand: "Yamaha",
      description: "צליל פסנתר פנטסטי בכלי השוקל מעט וקומפקטי במידותיו. Piaggero NP היא סדרת פסנתרים דיגיטליים אידיאלית ואלגנטית בפשטותה. היא הוצבה עם האלמנטים ההכרחיים בלבד המאפשרים לכם להתרכז בנגינה. סדרת NP מתרכזת בהנאה וההשראה שבנגינת פסנתר עם התמקדות עיקרית בצליל פסנתר הכנף מהמשובחים של Yamaha.",
      quantity: 10,
      createBy: "shely admin"
    },
    {
      ...
      description: "במשך למעלה מ-160 שנים שחברת Steinway & Sons מקדישה עצמה לייצור הפסנתרים הטובים בעולם. השיטות החלוציות בעבודת יד כמיטב המסורת פועלות עד היום על מנת להבטיח את הסטנדרטים הבלתי מתפשרים של האיכות, הצליל, הטאץ' והיופי.",
      quantity: 15,
      createBy: "shely admin"
    }
  ]