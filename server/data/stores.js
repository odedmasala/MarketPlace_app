const stores = [
    {
      bnNumber: "aaa111",
      name: "נוי השדה",
      description: "נוי השדה מביאה אליך הביתה את כל טוב השדה ובאכות הכי גבוהה שיש",
      logo: {
    ...
    },
    {
      bnNumber: "aaa222",
      name: "המושבה",
      description: "המושבה יבואנית הפירות הותיקה בשוק , הפרות והירקות שכולנו גדלנו עליהם",
      logo: {
    ...
    },
    {
      bnNumber: "bbbb22222",
      name: "musicZol",
      description: "מיוסקזול חרטה על דגלה להביא ללקוחתייה את כלי הנגינה ברמה הגבוה ביותר",
      logo: {
    ...
    },
    {
      bnNumber: "bbb1111",
      name: "SARINA RECORDS",
      description: "סרינה רקורד'ס באה לתת לכם את כל כלי הנגינה במחיר שווה לכל כיס",
      logo: {
    ...
    },
    {
      bnNumber: "cccc22222",
      name: "בי פארם",
      description: "בי פארם הוקמה בשנת 2019 כשראתה את עליית המחירים והחליטה להפוך לרשת החברתית הראשונה בישראל  ",
      logo: {
    ...
    },
    {
      bnNumber: "ddd11111",
      name: "באר המשקאות",
      description: "כשאתה מארגן אירוע ואתה נהיה צמא מרוב תכנון בוא לבאר המשקאות ואנחנו נרווה את הצמא שלך",
      logo: {
